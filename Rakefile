...
I have a very playful and well socialized pug; he's 3 years old. I also live directly across a gated, off-leash dog park that we will go to play and get some exercise at.", profile_picture: "https://d3n8a8pro7vhmx.cloudfront.net/bobbrownfoundation/pages/1/attachments/original/1392468553/bob-dappled-shade.jpg?1392468553")
  ...
  Booking.create!(host_id: eating.id, dog_id: user2.id, dog_feedback: 5, owner_feedback: 3, dog_comments: "To be, or not to be; that is the question; Whether ‘tis nobler in the mind to suffer The slings and arrows of outrageous fortune, Or to take arms against a sea of troubles;", owner_comments: "awesome dog")
  Booking.create!(host_id: zen.id, dog_id: user2.id, dog_feedback: 4, owner_feedback: 5, dog_comments: "To be, or not to be; that is the question; Whether ‘tis nobler in the mind to suffer The slings and arrows of outrageous fortune, Or to take arms against a sea of troubles", owner_comments: "This dog made my day. Very friendly.")
